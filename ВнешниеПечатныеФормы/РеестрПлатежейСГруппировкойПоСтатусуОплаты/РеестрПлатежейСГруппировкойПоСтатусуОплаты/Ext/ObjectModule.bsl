...
Функция ПечатьМакетаРеестраНаОплату(МассивОбъектов,	ОбъектыПечати, ПараметрыВывода) 
	...
	Пока ВыборкаРеестр.Следующий() Цикл
		...
		|	игсЗаявкаНаОплатуДокументыРасчетов.Ссылка.СтатьяДвиженияДенежныхСредств КАК СтатьяДвиженияДенежныхСредств
		...
		|	Вт_ЗаявкиИСчетаНаОплату.Заявка.СтатьяДвиженияДенежныхСредств КАК ЗаявкаСтатьяДвиженияДенежныхСредств
		...
		|	ВТ_НоменклатурныеГруппыДляПроверки.ЗаявкаСтатьяДвиженияДенежныхСредств КАК ЗаявкаСтатьяДвиженияДенежныхСредств
		|ПОМЕСТИТЬ ВТ_НГДР
		|ИЗ
		...
		|	ВТ_НГДР.ЗаявкаСтатьяДвиженияДенежныхСредств КАК ЗаявкаСтатьяДвиженияДенежныхСредств
		...
		|	"""" КАК Статья2,
		|	ВТ_ЗаявкиПоКоторымПроизведенаОплата.ЗаявкаСтатьяДвиженияДенежныхСредств КАК СтатьяДДС,
		|	"""" КАК Статья1
		|ИЗ
		...
		|	"""",
		|	ВТ_ОплаченныеЭтапыРабот.ЗаявкаСтатьяДвиженияДенежныхСредств,
		|	""""
		|ИЗ
