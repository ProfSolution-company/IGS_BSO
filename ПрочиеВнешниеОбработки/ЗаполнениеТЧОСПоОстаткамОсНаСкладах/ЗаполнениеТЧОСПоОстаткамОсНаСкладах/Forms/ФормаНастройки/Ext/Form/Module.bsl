...
Процедура ВыполнитьКоманду(ИдентификаторКоманды, ОбъектыНазначенияМассив) Экспорт    
	...
	ЭтоПеремещение 			=?(ТипЗнч(Объект.СсылкаНаОбъект) = Тип("ДокументСсылка.ПеремещениеОС"), Истина, Ложь);
	ЭтоИзменениеОС 			=?(ТипЗнч(Объект.СсылкаНаОбъект) = Тип("ДокументСсылка.ИзменениеСостоянияОС"), Истина, Ложь);
