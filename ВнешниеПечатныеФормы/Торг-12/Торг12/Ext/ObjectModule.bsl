...
Функция ПечатьТОРГ12(СведенияТОРГ12, ОбъектыПечати, ПараметрыПечати) 
	...
	Для Каждого СведенияОДокументе Из СведенияТОРГ12 Цикл
		...
		// {{ ПрофРешение Брикотнин М.А. - 11.11.2025 - #Задача № 0147
		игсЭтоИГСАвто = СведенияОДокументе.Организация.игсЭтоИГСАвто;
		...
		ДополнительныеПараметрыШапки.Вставить("ОрганизацияПоОКПО",          КодыОКПО[СведенияОДокументе.Грузоотправитель]);
		ДополнительныеПараметрыШапки.Вставить("ВидДеятельностиПоОКДП",      "");
		ДополнительныеПараметрыШапки.Вставить("ГрузополучательПоОКПО",      КодыОКПО[СведенияОДокументе.Грузополучатель]);
		ДополнительныеПараметрыШапки.Вставить("ПоставщикПоОКПО",            КодыОКПО[СведенияОДокументе.Поставщик]);
		ДополнительныеПараметрыШапки.Вставить("ПлательщикПоОКПО",           КодыОКПО[СведенияОДокументе.Покупатель]);
