...
Функция ПолучитьТекстОсновногоЗапроса()
	...
	|			ИНАЧЕ ЛОЖЬ
	|		КОНЕЦ
	|	И АвансовыйОтчет.Дата > &НачалоПериода
	|	И АвансовыйОтчет.Дата < &КонецПериода
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	И ОтражениеЗарплатыВУчете.Дата > &НачалоПериода
	|	И ОтражениеЗарплатыВУчете.Дата < &КонецПериода
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|			ИНАЧЕ ЛОЖЬ
	|		КОНЕЦ
	|	И игсПрочиеЗатратыКРаспределению.Дата > &НачалоПериода
	|	И игсПрочиеЗатратыКРаспределению.Дата < &КонецПериода
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|			ИНАЧЕ ЛОЖЬ
	|		КОНЕЦ
	|	И ТребованиеНакладная.Дата > &НачалоПериода
	|	И ТребованиеНакладная.Дата < &КонецПериода
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
