...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Дата = КонецМесяца(КомпоновщикНастроек.ПользовательскиеНастройки.Элементы[ДатаИндекс].Значение.Дата);
	...
	// <ИГС> ПР Потылицын Г.С. #0113 10.09.2025 {
<<<<<<< HEAD:ВнешниеОтчеты/игсОшибкиПриПредварительномРаспределенииПоСправкамЛСЗ/игсОшибкиПриПредварительномРаспределенииПоСправкамЛСЗ1/Ext/ObjectModule.bsl
...
>>>>>>> origin/main:ВнешниеОтчеты/игсОшибкиПриПредварительномРаспределенииПоСправкамЛСЗ/игсОшибкиПриПредварительномРаспределенииПоСправкамЛСЗ/Ext/ObjectModule.bsl
	// } </ИГС>
