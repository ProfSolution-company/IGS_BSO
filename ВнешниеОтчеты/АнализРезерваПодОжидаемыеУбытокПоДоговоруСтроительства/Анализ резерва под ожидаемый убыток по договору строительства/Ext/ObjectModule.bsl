...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Запрос.УстановитьПараметр("Организация", Справочники.Организации.ПолучитьСсылку(Новый УникальныйИдентификатор("d4158604-e70a-4c5c-a9ea-b2f7b4ede3f6")));//АО "Инвестгеосервис" + (Справочник.Организации)
	...
	Если Результат.Пустой() Тогда
		ОбщегоНазначения.СообщитьПользователю("Вид резерва убыточных проектов не был выбран для данной организации");
		Возврат;
	КонецЕсли;
